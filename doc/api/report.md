...
- `--experimental-report` Enables the diagnostic report feature. In the absence
  of this flag, use of all other related options will result in an error.
...
allows the report to include the location of the original error as well as where
it was handled.
...
URLs are not supported. Defaults to the current working directory of the Node.js
process.
