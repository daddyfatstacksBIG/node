...
function mocks(server) {
  // ls current package
  server
    .get("/-/package/@scoped%2fpkg/dist-tags")
  ...
  // ls named package
  server
    .get("/-/package/@scoped%2fanother/dist-tags")
  ...
  server
    ...
    .reply(200, { latest: "2.0.0", a: "0.0.2", b: "0.6.0" });
  server
    .put("/-/package/@scoped%2fanother/dist-tags/c", '"7.7.7"')
  ...
  server
    .delete("/-/package/@scoped%2fanother/dist-tags/c")
    .reply(200, { c: "7.7.7" });

  // using a scoped registry
  server
    .get("/-/package/@scoped%2ffoo/dist-tags")
    .reply(200, { latest: "2.0.0", a: "0.0.2", b: "0.6.0" });
  server
    .delete("/-/package/@scoped%2ffoo/dist-tags/b")
    .reply(200, { b: "0.6.0" });
...
test("npm dist-tags ls in current package", function(t) {
  common.npm(
    ["dist-tags", "ls", "--registry", common.registry, "--loglevel", "silent"],
    { cwd: pkg },
...
test("npm dist-tags ls default in current package", function(t) {
  common.npm(
    ["dist-tags", "--registry", common.registry, "--loglevel", "silent"],
    { cwd: pkg },
    function(er, code, stdout, stderr) {
      t.ifError(er, "npm access");
      t.notOk(code, "exited OK");
