...
const packageWithoutTypeMain = require.resolve(
  "../fixtures/es-modules/package-without-type/index.js"
);
const packageTypeCommonJsMain = require.resolve(
  "../fixtures/es-modules/package-type-commonjs/index.js"
);
const packageTypeModuleMain = require.resolve(
...
try {
  ...
  assert(
    e
      .toString()
      .match(/Error \[ERR_REQUIRE_ESM\]: Must use import to load ES Module:/)
  );
}
