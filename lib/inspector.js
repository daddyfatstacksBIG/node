...
class Session extends EventEmitter {
  ...
  connect() {
    ...
    this[connectionSymbol] = new Connection(message =>
      this[onMessageSymbol](message)
    );
  }
  ...
  connectToMainThread() {
    ...
    if (this[connectionSymbol])
      throw new ERR_INSPECTOR_ALREADY_CONNECTED("The inspector session");
    this[connectionSymbol] = new MainThreadConnection(message =>
      queueMicrotask(() => this[onMessageSymbol](message))
    );
  }
